...
class Patient(BaseModel):
    ...
    city : Annotated[str, Field(..., description='Name of the patient living')]
...
def hello():
    return {'message':"Patients Managament System"}
...
@app.get("/sort")
def sort_patients(sort_by:str = Query(..., description="Sort on the basis height,weight or bmi"), order:str=Query('asc',description="sort in asc or desc")):
